    ...
    <div className="App">
      <div className="teamList">
        <div className="teamCard teamOne">
          ...
          <h6 className="teamPlayers"> MS : {menSingleList[0].name}</h6>
          <h6 className="teamPlayers"> WS : {womenSingleList[0].name}</h6>
          <h6 className="teamPlayers"> MD : {menDoubleList[0].name}</h6>
          <h6 className="teamPlayers"> WD : {womenDoubleList[0].name}</h6>
          <h6 className="teamPlayers"> XD : {mixDoubleList[0].name}</h6>
        </div>
